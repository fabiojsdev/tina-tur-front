...
// ─── Substitua pelo número real com DDI + DDD ───────────────────────────────
...
function FloatingButtons() {
  ...
  return (
    <>
      {/* WhatsApp – left side */}
      <a
        href={`https://wa.me/${WHATSAPP_NUMBER}?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20pacotes%20de%20viagem.`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Falar pelo WhatsApp"
        className="fixed left-5 bottom-8 z-50 flex items-center gap-2.5 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-2xl hover:bg-[#1ebe59] hover:scale-105 transition-all duration-300"
      >
    ...
    <Router>
      ...
      <div className="min-h-screen bg-[#f9f6f0]">
        ...
        <Routes>
          ...
          {/* Admin: acesse /admin com a senha tina2024 */}
